    ...
    <main class="container py-5">
        <section class="hero-card mx-auto" style="max-width: 760px;">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-4">
                <div>
                    <h1 class="hero-title mb-3">404</h1>
                    <h2 class="h3 fw-bold mb-3">The page you requested is not available.</h2>
                ...
                <div class="section-card text-center" style="min-width: 200px;">
                    <div class="empty-state-icon mx-auto"><i class="bi bi-compass-fill"></i></div>
                    <p class="fw-semibold mb-1">Missing destination</p>
                    <p class="section-copy mb-0">Try using the main navigation to continue.</p>
                </div>
            </div>
        </section>
    </main>
